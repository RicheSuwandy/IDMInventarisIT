...
Public Class crCheckListMaster
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IDM_Inventaris_HW_SW.crCheckListMaster.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCheckListMaster
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCheckListMaster = New crCheckListMaster()
        rpt.Site = Me.Site
        Return rpt
    End Function
