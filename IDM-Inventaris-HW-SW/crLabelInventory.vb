...
Public Class crLabelInventory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IDM_Inventaris_HW_SW.crLabelInventory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrLabelInventory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crLabelInventory = New crLabelInventory()
        rpt.Site = Me.Site
        Return rpt
    End Function
