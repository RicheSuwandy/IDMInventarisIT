...
Public Class crInvBarcode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IDM_Inventaris_HW_SW.crInvBarcode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrInvBarcode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crInvBarcode = New crInvBarcode()
        rpt.Site = Me.Site
        Return rpt
    End Function
